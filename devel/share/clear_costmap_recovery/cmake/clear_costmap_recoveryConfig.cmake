...
if("TRUE" STREQUAL "TRUE")
  set(clear_costmap_recovery_SOURCE_PREFIX /home/vboxuser/myagv_ros/src/navigation/clear_costmap_recovery)
  set(clear_costmap_recovery_DEVEL_PREFIX /home/vboxuser/myagv_ros/devel)
  ...
  set(clear_costmap_recovery_INSTALL_PREFIX /home/vboxuser/myagv_ros/install)
...
if(NOT "/home/vboxuser/myagv_ros/src/navigation/clear_costmap_recovery/include " STREQUAL " ")
  set(clear_costmap_recovery_INCLUDE_DIRS "")
  set(_include_dirs "/home/vboxuser/myagv_ros/src/navigation/clear_costmap_recovery/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'clear_costmap_recovery' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/vboxuser/myagv_ros/src/navigation/clear_costmap_recovery/${idir}'.  ${_report}")
    endif()
