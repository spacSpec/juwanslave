...
class TaskManagerNode(Node):
    def __init__(self):
        ...
        self.is_waiting_agv = False # [AGV 대기 상태 플래그]
    ...
    def arm_done_callback(self, future):
        try:
            ...
            # 5. 박스 만재 시 AGV 호출 (3개 다 차면)
            # (만약 테스트를 빨리 하고 싶으면 2로 낮춰도 됩니다)
            if self.box_item_count >= 3:
